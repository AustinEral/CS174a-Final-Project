...
export class Obj_File_Demo extends Scene {                           // **Obj_File_Demo** show how to load a single 3D model from an OBJ file.
    ...
    display(context, program_state) {
        ...
        program_state.set_camera(Mat4.translation(0, 0, -5).times(Mat4.rotation(Math.PI/2, 1, 0, 0)).times(Mat4.translation(0, 0, 0)).times(Mat4.rotation(Math.PI/3, 0, 0, 1)));    // Locate the camera here (inverted matrix).
