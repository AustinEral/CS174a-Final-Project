...
export class Final_Project extends Scene {
    ...
    display(context, program_state) {
        ...
        // Lights
        const light_movement = 2*Math.cos(Math.PI*t/2);
        const light_movement2 = 2*Math.sin(Math.PI*t/2);
        ...
        this.shapes.box.draw(context, program_state, b_wall_transform, this.materials.room);
